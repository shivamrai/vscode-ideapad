...
class ModelLoadError(ModelError):
    ...
    def __init__(self, detail: ModelErrorDetailEnum = ModelErrorDetailEnum.MODEL_INFERENCE_ERROR):
        self.detail = detail
        super().__init__(self.detail)

class ModelShutdownError(ModelError):
    """Raised when shutting down or cleaning up the model fails."""
    def __init__(self, detail: ModelErrorDetailEnum = ModelErrorDetailEnum.MODEL_SHUTDOWN_ERROR):
        self.detail = detail
        super().__init__(self.detail)

class InvalidPromptError(ModelError):
    """Raised when an empty or invalid prompt is provided."""
    def __init__(self, detail: ModelErrorDetailEnum = ModelErrorDetailEnum.INVALID_PROMPT_ERROR):
        self.detail = detail
        super().__init__(self.detail)
...
class ModelInvalidResponseError(ModelError):
    ...
    def __init__(self, detail: ModelErrorDetailEnum = ModelErrorDetailEnum.MODEL_INVALID_RESPONSE_ERROR):
        self.detail = detail
        super().__init__(self.detail)

class ConversationNotFoundError(ModelError):
    """Raised when an unknown conversation ID is used."""
    def __init__(self, detail:ModelErrorDetailEnum = ModelErrorDetailEnum.CONVERSATION_NOT_FOUND_ERROR):
        super().__init__(detail)

class ModelInitError(ModelError):
    """Raised when the model fails to initialize."""
    def __init__(self, detail:ModelErrorDetailEnum = ModelErrorDetailEnum.MODEL_INITIALIZATION_ERROR):
        super().__init__(detail)
